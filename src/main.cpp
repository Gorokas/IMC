...
const string strMessageMagic = "InternetMarketingCoins Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    {
        nSubsidy = 30000000 * COIN; // 100% Premine
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "InternetMarketingCoins", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Freelance Tokens";
        CTransaction txNew;
        txNew.nTime = 1408137500;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1408137500;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
		block.nNonce   = 1475669;
		if(fTestNet)
        {
            block.nNonce   = 85332;
        }
       ...
       if (true && (block.GetHash() != hashGenesisBlock)) {
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xd34b2fd4723086d2583cba9fe9a0cb56e8f05f1dd14de9464e7b935373675893"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfa, 0xfa, 0xfa, 0xef };
