// Copyright (c) 2014 The InternetMarketingCoins developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("internetmarketingcoins-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("internetmarketingcoins-smsg-pow"); // Make this thread recognisable
